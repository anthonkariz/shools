...
<div class="row">
  ...
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#home">All teachers</a>
  </li>
  <li class="nav-item">
...
<div class="tab-content">
 ...
 <?php 
  foreach($db->findAll('teacher') as $rows): ?>
    <tr>
      <td><?php echo $rows['title'] ; ?></td>
      <td><?php echo $rows['first_name'] ; ?></td>
      <td><?php echo $rows['Surname'] ; ?></td>
       <td> <a href="singleteacher.php?id=<?php echo $rows['id'] ; ?>" class="btn btn-primary" >View More</a>  </td>
    </tr> 
